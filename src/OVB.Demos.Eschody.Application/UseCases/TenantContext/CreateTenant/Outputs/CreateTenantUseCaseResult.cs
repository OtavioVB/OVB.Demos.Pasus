...
public readonly struct CreateTenantUseCaseResult
{
    ...
    public static CreateTenantUseCaseResult Build(TenantCredentialsValueObject credentials, EmailValueObject email, PasswordValueObject password, ComercialNameValueObject comercialName, SocialReasonValueObject socialReason, CnaeCodeValueObject primaryCnaeCode, CnpjValueObject cnpj, CompositionValueObject composition, TenantScopeValueObject scope, FoundationDateValueObject foundationDate, DateTime isAvailableUntil, bool isEnabled)
        => new CreateTenantUseCaseResult(credentials, email, password, comercialName, socialReason, primaryCnaeCode, cnpj, composition, scope, foundationDate, isAvailableUntil, isEnabled);
}
